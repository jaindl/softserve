...
| File | What it is |
|---|---|
| `SKILL.md` | The full spec: palette, type, layouts, rules |
| `reference/design-doc.html` | Rendered design reference |
| `template/poster.html` | Starter 1080x1350 poster template |
